...
public class PlayerView extends JPanel {
	...
	public PlayerView(Player p, boolean showComplete){
		...
		this.worker_nbV = new JLabel(this.player.getWorker_num()+"");
		
		this.scoreV.setFont(new Font("SansSerif", Font.PLAIN, 22));
		this.nameV.setFont(new Font("SansSerif", Font.PLAIN, 22));
		this.worker_nbV.setFont(new Font("SansSerif", Font.PLAIN, 22));
		...
		this.scoreV.setOpaque(false);
		this.worker_nbV.setOpaque(false);
		//this.colorV.setOpaque(false);
	}
